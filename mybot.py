...
async def on_ready():
    ...
    guild = discord.Object(id=894871922637172747)
    await tree.sync(guild=guild)
    logging.info(f"Commands synced to guild: {894871922637172747}")
...
@tree.command(name="wake", description="ปลุกผู้ใช้ด้วย DM", guild=discord.Object(id=894871922637172747))
